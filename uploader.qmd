...
ojs_define(allmeta=toJSON(meta))
``` 
...
viewof indicator=Inputs.radio(component.indices,{value: component.indices[0],label: component.name})
...
ind_url="https://oceanview.pfeg.noaa.gov/erddap/tabledap/CCIEA_metadata.jsonlKVP?&currently_served=1&indicator_title="+'"'+encodeURIComponent(indicator)+'"'
