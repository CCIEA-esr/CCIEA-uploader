...
### View Current Data {expandable=false}
...
html`
			<div class="vert">
				${m.default_figure ? html `<div><img class="blm" src="${m.default_figure}"></iron-image></div>` : html `No image found for this indicator`}
